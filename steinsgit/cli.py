"""Command line entry point.
    ...
    steinsgit [repo] [--days 90] [--port 8787]

Installed as the `steinsgit` console script; also reachable as
`python -m steinsgit` and through the `./steinsgit.py` script at the repository
root. No dependencies beyond Python 3.9, git, and (optionally) the `claude` CLI.
"""
...
BANNER = r"""
   ____  _____  _____  ___  _   _  ____    ____  ___  _____
  / ___||_   _|| ____||_ _|| \ | |/ ___|  / ___||_ _||_   _|
  \___ \  | |  |  _|   | | |  \| |\___ \ | |  _  | |   | |
   ___) | | |  | |___  | | | |\  | ___) || |_| | | |   | |
  |____/  |_|  |_____||___||_| \_||____/  \____||___|  |_|
